...
- Graph-aware wins on 4 of 20 queries — most cleanly on lookup and relational questions whose answers depend on Wikidata properties (release year, developer, license) that graph-structured retrieval can surface more directly than dense retrieval; see [`raw_results.jsonl`](./runs/2026-05-05_6d8256d1fe5c_seed-0/raw_results.jsonl).
